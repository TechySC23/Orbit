...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, onNavigate, className = "" }) => {
	...
	return (
      ...
      `}
			...
			<div className='h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-700'>
				...
				:	<h1 className='text-xl font-bold text-gray-900 dark:text-gray-100'>Orbit</h1>}
			</div>

			{/* Navigation */}
			<nav className='flex-1 px-3 py-4 space-y-1' role='navigation' aria-label='Sidebar navigation' onKeyDown={onKeyDown}>
