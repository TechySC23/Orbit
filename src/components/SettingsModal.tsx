        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            >
                <div className="flex justify-between items-center mb-6">
                    <h2 id="settings-title" className="text-2xl font-semibold text-slate-100">Settings</h2>
                    <button onClick={handleClose} className="p-1 rounded-md hover:bg-slate-700/80 focus:outline-none focus:ring-2 focus:ring-sky-500/60" aria-label="Close settings">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="font-select" className="block text-base font-medium text-slate-300 mb-2">Font Family</label>
                        <select 
                            id="font-select" 
                            value={settings.font} 
                    ...
                    <div className="flex items-center justify-between bg-slate-900/50 p-3 rounded-md">
                        <label htmlFor="save-draft-toggle" className="text-base font-medium text-slate-300">Save new tasks as draft</label>
                        <button
                            role="switch"
                        ...
                        >
                            <span className={`${settings.saveDraft ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-white transition-transform`} />
                        </button>
                    </div>

                    {/* Reduce Motion Toggle */}
                    <div className="flex items-center justify-between bg-slate-900/50 p-3 rounded-md">
                        <label htmlFor="reduce-motion-toggle" className="text-base font-medium text-slate-300">Reduce motion</label>
                        <button
                            role="switch"
                        ...
                        >
                            <span className={`${settings.reduceMotion ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-white transition-transform`} />
                        </button>
                    </div>
                ...
                <div className="mt-8 flex justify-end">
                    <button onClick={handleClose} className="px-5 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 text-slate-100 font-semibold focus:outline-none focus:ring-2 focus:ring-sky-500/60">Done</button>
                </div>
            </div>
        </div>
    );
